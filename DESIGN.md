...
The game view is a high-fidelity rain-soaked neon cyberpunk district: dense geometry, high-resolution characters, detailed props, real materials, physically based lighting, real proportions, and visceral gore, with bloom, minimap pings, and faction-colored identity cues. The app layer should stay colder and more bureaucratic than the city: panels, cards, logs, and buttons should read like an internal corporate control system laid over a chaotic tactical simulation.

...
// the asset packs; list them here or the menu and first-contract totals
// undercount transfer (empty while presentation is procedural-only)
const menuRuntimeAssets = [];
